...
def get_contact_details_and_photo(house, rep_type, role):
    contact_data = {
        "🔵 Samrat Ashoka": {
            "👔 Faculty In-charge": ("Prof JB Jawale, 7457924466", "photo_path/faculty_incharge_ashoka.jpg"),
            "👥 Faculty Representative": ("Dr. Dipika Birari, Mr. Anup Kadam, Ms. Gouri Bhasale, Pravin Sangle", "photo_path/faculty_rep_ashoka.jpg"),
            "💼 House BE Mentor": ("Ayush Ojha, 6264389700, Akriti Singh, 7457924466", "photo_path/mentor_ashoka.jpg"),
            "🏅 House Captain": ("Ankit Yadav, 7494924041, Tanisha Sharma, 9419604895", "photo_path/captain_ashoka.jpg"),
            "🎖 House Vice-Captain": ("Akash Singh, 9571265207, Sunandha Reddy, 9571067672", "photo_path/vice_captain_ashoka.jpg")
        },
        "🟤 Raja Krishnadevaraya": {
            "👔 Faculty In-charge": ("Dr. Pritee Purohit, 9351447398", "photo_path/faculty_incharge_krishnadevaraya.jpg"),
            "👥 Faculty Representative": ("Mr. Sukumar Chaughule, Mr. Yuvraj Gholap", "photo_path/faculty_rep_krishnadevaraya.jpg"),
            "💼 House BE Mentor": ("Shivram, 9351447398, Ritika, 8983829429", "photo_path/mentor_krishnadevaraya.jpg"),
            "🏅 House Captain": ("Rohit Kumar, 9462007939, Shaikh Haseena, 8459258517", "Screenshot 2024-10-07 171934.jpg"),
            "🎖 House Vice-Captain": ("Piyush Saini, 9599478220, Kritika, 6267007012", "photo_path/vice_captain_krishnadevaraya.jpg")
        },
        "🟢 Maharana Pratap": {
            "👔 Faculty In-charge": ("Dr. Ashwini Sapkal, 7518470604", "photo_path/faculty_incharge_pratap.jpg"),
            "👥 Faculty Representative": ("Mr. Girish Kapse, Ms. Sushma Shirke, Mr. Anand", "photo_path/faculty_rep_pratap.jpg"),
            "💼 House BE Mentor": ("Pranay Puniya, 7851847604, Aditi More, 9501501733", "photo_path/mentor_pratap.jpg"),
            "🏅 House Captain": ("Krishan Kumar, 8941989000, Ashritha Reddy, 7386705828", "photo_path/captain_pratap.jpg"),
            "🎖 House Vice-Captain": ("Shivam Sharma, 8354099643, Ritika Kumari, 882469 3065", "photo_path/vice_captain_pratap.jpg")
        },
        "🟠 Chhatrapati Shivaji Maharaj": {
            "👔 Faculty In-charge": ("Prof MB Lonare, 9971018972", "photo_path/faculty_incharge_shivaji.jpg"),
            "👥 Faculty Representative": ("Mr. Vijay Karra, Mr. Sandeep Sampleti, Dr. SM Gaikwad", "photo_path/faculty_rep_shivaji.jpg"),
            "💼 House BE Mentor": ("Piyush, 7905061506, Anushna Panwar, 9971081972", "photo_path/mentor_shivaji.jpg"),
            "🏅 House Captain": ("Pratham Kumar, 703771998, Khushia, 7850005774", "photo_path/captain_shivaji.jpg"),
            "🎖 House Vice-Captain": ("Shivang Kumar, 6395926392, Khushboo, 9341692964", "photo_path/vice_captain_shivaji.jpg")
        }
    }
...
def representative_role_selection(message):
    if message.text in ["👔 Faculty In-charge", "👥 Faculty Representative", "💼 House BE Mentor", "🏅 House Captain", "🎖 House Vice-Captain"]:
        ...
        bot.reply_to(message, "𝐘𝐚𝐡𝐢 𝐡 𝐊𝐲𝐚?")
